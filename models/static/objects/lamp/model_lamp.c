...
Vtx lamp_Lamp_mesh_vtx_0[110] = {
	...
	{{{-128, -682, 128},0, {368, 496},{0xB7, 0x49, 0x49, 0xFF}}},
	{{{128, -682, 128},0, {368, 752},{0x49, 0x49, 0x49, 0xFF}}},
	{{{-128, -655, 128},0, {531, 496},{0xB5, 0x45, 0x4B, 0xFF}}},
	{{{-128, -682, -128},0, {368, 240},{0xB7, 0x49, 0xB7, 0xFF}}},
	{{{-128, -655, -128},0, {531, 240},{0xB5, 0x45, 0xB5, 0xFF}}},
	{{{128, -655, -128},0, {275, 496},{0x4B, 0x45, 0xB5, 0xFF}}},
	{{{128, -682, 128},0, {112, 240},{0x49, 0x49, 0x49, 0xFF}}},
	{{{128, -682, -128},0, {112, 496},{0x49, 0x49, 0xB7, 0xFF}}},
	...
	{{{128, -682, -128},0, {624, 240},{0x49, 0x49, 0xB7, 0xFF}}},
	{{{-128, -682, -128},0, {624, 496},{0xB7, 0x49, 0xB7, 0xFF}}},
	{{{-128, -682, 128},0, {368, 496},{0xB7, 0x49, 0x49, 0xFF}}},
	{{{128, -682, 128},0, {112, 240},{0x49, 0x49, 0x49, 0xFF}}},
	{{{78, 673, -78},0, {-16, 1008},{0x3A, 0x61, 0xC6, 0xFF}}},
	{{{-78, 673, -78},0, {-16, 1008},{0xC6, 0x61, 0xC6, 0xFF}}},
...
Gfx lamp_Lamp_mesh_tri_1[] = {
	...
	gsSPEndDisplayList(),
};Vtx lamp_Lamp_mesh_vtx_2[70] = {
	{{{0, 647, -15},0, {667, 155},{0x0, 0x38, 0x8E, 0xFF}}},
	{{{0, 698, 0},0, {581, -16},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{13, 647, -7},0, {496, 155},{0x62, 0x39, 0xC7, 0xFF}}},
	{{{22, 631, -13},0, {496, 325},{0x67, 0x2D, 0xC5, 0xFF}}},
	{{{22, 631, 13},0, {325, 325},{0x67, 0x2D, 0x3B, 0xFF}}},
	{{{13, 647, 7},0, {325, 155},{0x62, 0x39, 0x39, 0xFF}}},
	{{{0, 698, 0},0, {411, -16},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{0, 631, 26},0, {155, 325},{0x0, 0x2D, 0x77, 0xFF}}},
	{{{0, 647, 15},0, {155, 155},{0x0, 0x38, 0x72, 0xFF}}},
	{{{0, 698, 0},0, {240, -16},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{-22, 631, 13},0, {-16, 325},{0x99, 0x2D, 0x3B, 0xFF}}},
	{{{-13, 647, 7},0, {-16, 155},{0x9E, 0x39, 0x39, 0xFF}}},
	{{{0, 698, 0},0, {69, -16},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{-26, 609, 15},0, {-16, 496},{0x92, 0x0, 0x3F, 0xFF}}},
	{{{0, 609, 30},0, {155, 496},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{-22, 587, 13},0, {-16, 667},{0x99, 0xD3, 0x3B, 0xFF}}},
	{{{0, 609, 30},0, {155, 496},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{-22, 587, 13},0, {-16, 667},{0x99, 0xD3, 0x3B, 0xFF}}},
	{{{0, 587, 26},0, {155, 667},{0x0, 0xD3, 0x77, 0xFF}}},
	{{{-13, 571, 7},0, {-16, 837},{0xB5, 0xA3, 0x2B, 0xFF}}},
	{{{0, 571, 15},0, {155, 837},{0x0, 0xA3, 0x56, 0xFF}}},
	{{{0, 565, 0},0, {69, 1008},{0x0, 0x81, 0x0, 0xFF}}},
	{{{22, 587, 13},0, {325, 667},{0x67, 0xD3, 0x3B, 0xFF}}},
	{{{26, 609, 15},0, {325, 496},{0x6E, 0x0, 0x3F, 0xFF}}},
	{{{26, 609, -15},0, {496, 496},{0x6E, 0x0, 0xC1, 0xFF}}},
	{{{22, 587, -13},0, {496, 667},{0x67, 0xD3, 0xC5, 0xFF}}},
	{{{13, 571, 7},0, {325, 837},{0x4B, 0xA3, 0x2B, 0xFF}}},
	{{{0, 565, 0},0, {240, 1008},{0x0, 0x81, 0x0, 0xFF}}},
	{{{13, 571, -7},0, {496, 837},{0x4B, 0xA3, 0xD5, 0xFF}}},
	{{{0, 565, 0},0, {411, 1008},{0x0, 0x81, 0x0, 0xFF}}},
	{{{0, 587, -26},0, {667, 667},{0x0, 0xD3, 0x89, 0xFF}}},
	{{{0, 609, -30},0, {667, 496},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-26, 609, -15},0, {837, 496},{0x92, 0x0, 0xC1, 0xFF}}},
	{{{0, 609, -30},0, {667, 496},{0x0, 0x0, 0x81, 0xFF}}},
	{{{0, 587, -26},0, {667, 667},{0x0, 0xD3, 0x89, 0xFF}}},
	{{{-22, 587, -13},0, {837, 667},{0x99, 0xD3, 0xC5, 0xFF}}},
	{{{0, 571, -15},0, {667, 837},{0x0, 0xA3, 0xAA, 0xFF}}},
	{{{13, 571, -7},0, {496, 837},{0x4B, 0xA3, 0xD5, 0xFF}}},
	{{{0, 565, 0},0, {581, 1008},{0x0, 0x81, 0x0, 0xFF}}},
	{{{-13, 571, -7},0, {837, 837},{0xB5, 0xA3, 0xD5, 0xFF}}},
	{{{0, 565, 0},0, {752, 1008},{0x0, 0x81, 0x0, 0xFF}}},
	{{{-22, 587, 13},0, {1008, 667},{0x99, 0xD3, 0x3B, 0xFF}}},
	{{{-26, 609, 15},0, {1008, 496},{0x92, 0x0, 0x3F, 0xFF}}},
	{{{-22, 631, 13},0, {1008, 325},{0x99, 0x2D, 0x3B, 0xFF}}},
	{{{-22, 631, -13},0, {837, 325},{0x99, 0x2D, 0xC5, 0xFF}}},
	{{{-13, 647, 7},0, {1008, 155},{0x9E, 0x39, 0x39, 0xFF}}},
	{{{-13, 647, -7},0, {837, 155},{0x9E, 0x39, 0xC7, 0xFF}}},
	{{{0, 698, 0},0, {923, -16},{0x0, 0x7F, 0x0, 0xFF}}},
	{{{-13, 647, -7},0, {837, 155},{0x9E, 0x39, 0xC7, 0xFF}}},
	{{{0, 631, -26},0, {667, 325},{0x0, 0x2D, 0x89, 0xFF}}},
	{{{-22, 631, -13},0, {837, 325},{0x99, 0x2D, 0xC5, 0xFF}}},
	{{{0, 647, -15},0, {667, 155},{0x0, 0x38, 0x8E, 0xFF}}},
	...
	{{{-13, 571, 7},0, {1008, 837},{0xB5, 0xA3, 0x2B, 0xFF}}},
	{{{-13, 571, -7},0, {837, 837},{0xB5, 0xA3, 0xD5, 0xFF}}},
	{{{-22, 587, 13},0, {1008, 667},{0x99, 0xD3, 0x3B, 0xFF}}},
	{{{-22, 631, -13},0, {837, 325},{0x99, 0x2D, 0xC5, 0xFF}}},
	{{{0, 609, -30},0, {667, 496},{0x0, 0x0, 0x81, 0xFF}}},
...
Gfx lamp_Lamp_mesh_tri_2[] = {
	...
	gsSP1Triangle(7, 13, 14, 0),
	gsSP1Triangle(14, 13, 15, 0),
	gsSPVertex(lamp_Lamp_mesh_vtx_2 + 16, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	...
	gsSPVertex(lamp_Lamp_mesh_vtx_2 + 32, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 2, 3, 0),
	...
	gsSP1Triangle(13, 15, 14, 0),
	gsSPVertex(lamp_Lamp_mesh_vtx_2 + 48, 16, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	...
	gsSP1Triangle(12, 13, 14, 0),
	gsSP1Triangle(15, 14, 13, 0),
	gsSPVertex(lamp_Lamp_mesh_vtx_2 + 64, 6, 0),
	gsSP1Triangle(0, 1, 2, 0),
	gsSP1Triangle(0, 3, 1, 0),
	gsSP1Triangle(3, 4, 1, 0),
