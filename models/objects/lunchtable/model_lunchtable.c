...
Vtx lunchtable_Table_mesh_vtx_0[34] = {
	{{{0, 199, -213},0, {1008, 496},{0x0, 0xB2, 0x9B, 0xFF}}},
	{{{0, 208, -213},0, {1008, -16},{0x0, 0x4E, 0x9B, 0xFF}}},
	{{{184, 208, -106},0, {837, -16},{0x57, 0x4D, 0xCD, 0xFF}}},
	{{{184, 199, -106},0, {837, 496},{0x57, 0xB3, 0xCD, 0xFF}}},
	{{{184, 208, 106},0, {667, -16},{0x57, 0x4D, 0x33, 0xFF}}},
	{{{184, 199, 106},0, {667, 496},{0x57, 0xB3, 0x33, 0xFF}}},
	{{{0, 208, 213},0, {496, -16},{0x0, 0x4E, 0x65, 0xFF}}},
	{{{0, 199, 213},0, {496, 496},{0x0, 0xB2, 0x65, 0xFF}}},
	{{{-184, 208, 106},0, {325, -16},{0xA9, 0x4D, 0x33, 0xFF}}},
	{{{-184, 199, 106},0, {325, 496},{0xA9, 0xB3, 0x33, 0xFF}}},
	{{{-184, 208, -106},0, {155, -16},{0xA9, 0x4D, 0xCD, 0xFF}}},
	{{{-184, 199, -106},0, {155, 496},{0xA9, 0xB3, 0xCD, 0xFF}}},
	{{{0, 208, -213},0, {-16, -16},{0x0, 0x4E, 0x9B, 0xFF}}},
	{{{0, 199, -213},0, {-16, 496},{0x0, 0xB2, 0x9B, 0xFF}}},
	{{{0, 200, -17},0, {1008, 496},{0x0, 0x0, 0x81, 0xFF}}},
	{{{0, 214, -17},0, {1008, -16},{0x0, 0x4E, 0x9B, 0xFF}}},
	{{{15, 214, -9},0, {837, -16},{0x57, 0x4D, 0xCD, 0xFF}}},
	{{{15, 200, -9},0, {837, 496},{0x6E, 0x0, 0xC1, 0xFF}}},
	{{{15, 214, 9},0, {667, -16},{0x57, 0x4D, 0x33, 0xFF}}},
	{{{15, 200, 9},0, {667, 496},{0x6E, 0x0, 0x3F, 0xFF}}},
	{{{0, 214, 17},0, {496, -16},{0x0, 0x4E, 0x65, 0xFF}}},
	{{{0, 200, 17},0, {496, 496},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{-15, 214, 9},0, {325, -16},{0xA9, 0x4D, 0x33, 0xFF}}},
	{{{-15, 200, 9},0, {325, 496},{0x92, 0x0, 0x3F, 0xFF}}},
	{{{-15, 214, -9},0, {155, -16},{0xA9, 0x4D, 0xCD, 0xFF}}},
	{{{-15, 200, -9},0, {155, 496},{0x92, 0x0, 0xC1, 0xFF}}},
	{{{0, 214, -17},0, {-16, -16},{0x0, 0x4E, 0x9B, 0xFF}}},
	{{{0, 200, -17},0, {-16, 496},{0x0, 0x0, 0x81, 0xFF}}},
	{{{15, 214, 9},0, {453, 875},{0x57, 0x4D, 0x33, 0xFF}}},
	{{{15, 214, -9},0, {453, 629},{0x57, 0x4D, 0xCD, 0xFF}}},
	{{{0, 214, -17},0, {240, 506},{0x0, 0x4E, 0x9B, 0xFF}}},
	{{{-15, 214, 9},0, {27, 875},{0xA9, 0x4D, 0x33, 0xFF}}},
	{{{-15, 214, -9},0, {27, 629},{0xA9, 0x4D, 0xCD, 0xFF}}},
	{{{0, 214, 17},0, {240, 998},{0x0, 0x4E, 0x65, 0xFF}}},
};
...
Gfx lunchtable_Table_mesh_tri_0[] = {
	...
	{{{184, 208, 106},0, {453, 875},{0x57, 0x4D, 0x33, 0xFF}}},
	{{{184, 208, -106},0, {453, 629},{0x57, 0x4D, 0xCD, 0xFF}}},
	{{{0, 208, -213},0, {240, 506},{0x0, 0x4E, 0x9B, 0xFF}}},
	{{{-184, 208, 106},0, {27, 875},{0xA9, 0x4D, 0x33, 0xFF}}},
	{{{-184, 208, -106},0, {27, 629},{0xA9, 0x4D, 0xCD, 0xFF}}},
	{{{0, 208, 213},0, {240, 998},{0x0, 0x4E, 0x65, 0xFF}}},
	{{{-184, 199, -106},0, {539, 629},{0xA9, 0xB3, 0xCD, 0xFF}}},
	{{{0, 199, -213},0, {752, 506},{0x0, 0xB2, 0x9B, 0xFF}}},
	{{{184, 199, -106},0, {965, 629},{0x57, 0xB3, 0xCD, 0xFF}}},
	{{{0, 199, 213},0, {752, 998},{0x0, 0xB2, 0x65, 0xFF}}},
	{{{184, 199, 106},0, {965, 875},{0x57, 0xB3, 0x33, 0xFF}}},
	{{{-184, 199, 106},0, {539, 875},{0xA9, 0xB3, 0x33, 0xFF}}},
};
...
Gfx lunchtable_Table_mesh_tri_1[] = {
	...
	{{{-67, -9, 2},0, {1008, 1008},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{67, -9, 2},0, {-16, 1008},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{67, 195, 2},0, {-16, -16},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{-67, 195, 2},0, {1008, -16},{0x0, 0x0, 0x7F, 0xFF}}},
	{{{-67, -9, -2},0, {1008, 1008},{0x0, 0x0, 0x81, 0xFF}}},
	{{{-67, 195, -2},0, {1008, -16},{0x0, 0x0, 0x81, 0xFF}}},
	{{{67, 195, -2},0, {-16, -16},{0x0, 0x0, 0x81, 0xFF}}},
	{{{67, -9, -2},0, {-16, 1008},{0x0, 0x0, 0x81, 0xFF}}},
	{{{2, -9, 67},0, {1008, 1008},{0x7F, 0x0, 0x0, 0xFF}}},
	{{{2, -9, -67},0, {-16, 1008},{0x7F, 0x0, 0x0, 0xFF}}},
	{{{2, 195, -67},0, {-16, -16},{0x7F, 0x0, 0x0, 0xFF}}},
	{{{2, 195, 67},0, {1008, -16},{0x7F, 0x0, 0x0, 0xFF}}},
	{{{-2, -9, 67},0, {1008, 1008},{0x81, 0x0, 0x0, 0xFF}}},
	{{{-2, 195, 67},0, {1008, -16},{0x81, 0x0, 0x0, 0xFF}}},
	{{{-2, 195, -67},0, {-16, -16},{0x81, 0x0, 0x0, 0xFF}}},
	{{{-2, -9, -67},0, {-16, 1008},{0x81, 0x0, 0x0, 0xFF}}},
};
