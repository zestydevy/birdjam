...
const struct TObjectData gObjectDataList[] = 
{
    ...
    {noodle_Noodle_mesh, "Pool Toy", 0, true, 350.0f, 350.0f, 350.0f, SIZE_MAN, 50000.0f, DRAWDIST_QUARTER},
    ...
    {steppingstone_SteppingStone_mesh, "Path", 0, true, 150.0f, 150.0f, 150.0f, SIZE_LAYER2, 62000.0f, DRAWDIST_HALF},
    {fence_Fence_mesh, "Fence", 0, true, 273.0f, 273.0f, 273.0f, SIZE_LAYER3, 250000.0f, DRAWDIST_THREEQUARTERS},
    ...
    {tree2_bald_Tree_Bald_mesh, "Tree", 0, true, 106.0f, 106.0f, 106.0f, SIZE_LAYER3, 500000.0f, DRAWDIST_THREEQUARTERS},
    {tree1_bald_TreeBald_mesh, "Tree", 0, true, 106.0f, 106.0f, 106.0f, SIZE_LAYER3, 400000.0f, DRAWDIST_THREEQUARTERS},
