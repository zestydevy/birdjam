...
const struct TObjectData gObjectDataList[] = 
{
    ...
    {critic_Critic_mesh, "Human", 1, false, 200.0f, 900.0f, 200.0f, SIZE_MAN, 200, DRAWDIST_HALF},
    {avgn_AVGN_mesh, "Human", 1, false, 200.0f, 900.0f, 200.0f, SIZE_MAN, 200, DRAWDIST_HALF},
    {woman_Woman_mesh, "Human", 1, false, 200.0f, 900.0f, 200.0f, SIZE_MAN, 200, DRAWDIST_HALF},
    {child_Child_mesh, "Human", 1, false, 200.0f, 900.0f, 200.0f, SIZE_MAN, 200, DRAWDIST_HALF},
