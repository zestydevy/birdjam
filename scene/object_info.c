...
{
    {0, "null", 0, false, 0.0f, 0.0f, 0.0f, SIZE_IMPOSSIBLE, 0},
    {cube_Cube_mesh, "Cube", 1, false, 213.0f, 213.0f, 213.0f, SIZE_MED, 1},
    {balloon_Balloon_mesh, "Balloon", 0, false, 150.0f, 150.0f, 150.0f, SIZE_TINY, 5},
    ...
    {basket_Basket_mesh, "Basket", 1, false, 380.0f, 380.0f, 380.0f, SIZE_MED, 10},
    {beer_Beer_mesh, "Drink", 0, false, 380.0f, 380.0f, 380.0f, SIZE_SMALL, 5},
    {noodle_Noodle_mesh, "Pool Toy", 0, false, 106.0f, 106.0f, 106.0f, SIZE_LARGE, 10},
    {melon_Melon_mesh, "Melon", 0, false, 213.0f, 213.0f, 213.0f, SIZE_MED, 5},
    {apple_Apple_mesh, "Apple", 0, false, 170.0f, 170.0f, 170.0f, SIZE_SMALL, 0},
    {balloon_deflated_Balloon_Deflated_mesh, "Balloon", 0, false, 20.0f, 20.0f, 20.0f, SIZE_SMALL, 5},
    {beehive_Beehive_mesh, "Beehive", 0, false, 106.0f, 106.0f, 106.0f, SIZE_MED, 8},
    {bills_Bills_mesh, "Money", 0, false, 60.0f, 60.0f, 60.0f, SIZE_JEWELRY, 20},
    {card_Cube_mesh, "Card", 0, false, 213.0f, 213.0f, 213.0f, SIZE_JEWELRY, 2},
    {flower_Head_mesh, "Flower", 1, false, 30.0f, 60.0f, 30.0f, SIZE_SMALL, 3},
    {necklace_Necklace_mesh, "Necklace", 0, false, 213.0f, 213.0f, 213.0f, SIZE_JEWELRY, 25},
    {ring_Ring_mesh, "Ring", 0, false, 106.0f, 106.0f, 106.0f, SIZE_JEWELRY, 20},
    {zedball_Zedball_mesh, "Soccer Ball", 0, false, 250.0f, 250.0f, 250.0f, SIZE_MED, 10},
    {stick_Stick1_mesh, "Stick", 0, false, 106.0f, 106.0f, 106.0f, SIZE_SMALL, 1},
    {table_Table_mesh, "Table", 1, true, 250.0f, 250.0f, 250.0f, SIZE_LAYER1, 20},
    {cat_Cat_mesh, "Cat", 0, false, 372.0f, 372.0f, 372.0f, SIZE_ANIMAL, 50},
    {chicken_Chicken_mesh, "Chicken", 0, false, 292.0f, 292.0f, 292.0f, SIZE_ANIMAL, 30},
    {critic_Critic_mesh, "Human", 1, false, 200.0f, 926.0f, 200.0f, SIZE_MAN, 100},
    ...
    {leaves_Leaves_mesh, "Tree Leaves", 0, false, 106.0f, 106.0f, 106.0f, SIZE_MASSIVE, 5},
    ...
    {nest_Nest_mesh, "Nest", 2, 213.0f, false, 127.0f, 213.0f, SIZE_IMPOSSIBLE, 0},
    {treedead_Tree_Dead_mesh, "Dead Tree", 0, true, 106.0f, 256.0f, 106.0f, SIZE_LAYER3, 5},
    {tree2_bald_Tree_Bald_mesh, "Tree", 0, true, 106.0f, 106.0f, 106.0f, SIZE_LAYER3, 5},
    {tree1_bald_TreeBald_mesh, "Tree", 0, true, 106.0f, 106.0f, 106.0f, SIZE_LAYER3, 5},
    {tire_Tire_mesh, "Car Tire", 0,  true, 213.0f, 213.0f, 213.0f, SIZE_LAYER1, 15},
    {toaster_Toaster_mesh, "Old Toaster", 0,  false, 298.0f, 298.0f, 298.0f, SIZE_LARGE, 15},
    ...
    {pot_Pot_mesh, "Ceramic Pot", 0,  false, 170.5f, 170.5f, 170.5f, SIZE_LARGE, 5},
    {bush_Bush_mesh, "Bush", 0,  true, 404.5f, 404.5f, 404.5f, SIZE_LAYER2, 20},
    {lamp_Lamp_mesh, "Lamp", 1,  false, 127.8f, 681.6f, 127.8f, SIZE_GIANT, 30},
    {car_Car_mesh, "Car", 0,  true, 660.5f, 660.5f, 660.5f, SIZE_LAYER2, 20},
};